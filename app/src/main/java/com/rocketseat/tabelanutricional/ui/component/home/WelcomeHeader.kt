...
import com.rocketseat.tabelanutricional.ui.theme.Secondary
...
private const val NOTIFICATION_BADGE_CIRCLE_RADIUS_RATIO_DIVIDER = 1.5f
    ...
    Row(
        ...
        Column(
            ...
            Text(
                ...
                style = Typography.bodyLarge.copy(color = MaterialTheme.colorScheme.onSecondaryContainer)
            )
        }
                ...
                modifier = Modifier
                    ...
                    .drawWithContent {
                        ...
                        if (hasNewNotification) {
                            ...
                            drawCircle(
                                color = Secondary,
                                radius = circleRadius / NOTIFICATION_BADGE_CIRCLE_RADIUS_RATIO_DIVIDER,
                                center = Offset(
                                    x = size.width * NOTIFICATION_BADGE_OFFSET_X_RATIO,
                                    y = size.height * NOTIFICATION_BADGE_OFFSET_Y_RATIO
                                )
...
private fun WelcomeHeaderPreview() {
    TabelaNutricionalTheme {
        WelcomeHeader(
            modifier = Modifier.padding(TabelaNutricionalTheme.sizing.md),
            userName = "Carlos"
        )
    }
}
